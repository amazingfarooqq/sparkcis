...
export function Testimonials() {
  return (
    <>
      <section aria-label="A word from our users" className="w-full relative h-full py-32 ">
        ...
        <h3 className="pb-1.5 lg:leading-tight md:leading-tight relative z-20 2xl:text-5xl md:text-5xl text-3xl font-extrabold leading-tight text-center wordfromclient t-f-c bg-clip-text text-primary">
                ...
                <div className="flex flex-col h-full justify-between">
                  ...
                  <div className="mt-10 flex items-center ">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm font-light leading-none text-gray-600 dark:text-white mt-2">
